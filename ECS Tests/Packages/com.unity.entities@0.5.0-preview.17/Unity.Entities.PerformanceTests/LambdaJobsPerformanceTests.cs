                ...
                switch (componentCount)
                {
                    case 1:
                        Measure.Method(() =>
                            ...
                            .ProfilerMarkers("LambdaJobForEach")
                            .Run();
                        Measure.Method(() =>
                            {
                            ...
                            .WarmupCount(5)
                            .MeasurementCount(100)
                            .ProfilerMarkers("IJobForEachWithEntity")
                            .Run();
                        break;
                    case 2:
                        Measure.Method(() =>
            ...
            using (var entities = new NativeArray<Entity>(entityCount, Allocator.TempJob))
            {
                ...
                if (withPointerCapture)
                {
                    Measure.Method(() => { TestSystem.SimpleLambdaWithPointerCapture(); })
                        .WarmupCount(5)
                        .MeasurementCount(100)
                        .ProfilerMarkers("LambdaJobsForEach_Performance_WithPointerCapture")
                        .Run();
                }
                else
                {
                    Measure.Method(() => { TestSystem.SimpleLambda(); })
                        .WarmupCount(5)
                        .MeasurementCount(100)
                        .ProfilerMarkers("LambdaJobsForEach_Performance_Simple")
                        .Run();
                }
            }
        }
            ...
            using (var entities = new NativeArray<Entity>(entityCount, Allocator.TempJob))
            {
                ...
                if (withECB)
                {
                    Measure.Method(() =>
                        ...
                        .ProfilerMarkers("StructuralChangesWithECB")
                        .Run();
                }
                else
                {
                    Measure.Method(() =>
                        ...
                        .ProfilerMarkers("StructuralChangesInLambda")
                        .Run();
                }
            }
        }
